package com.crebsthecoder.skwasp.elements.other.events;
...
import com.crebsthecoder.skwasp.api.event.EntityBlockInteractEvent;
...
public class OtherEvents extends SimpleEvent {
    ...
    static {
        ...
        EventValues.registerEventValue(EntityAirChangeEvent.class, Timespan.class, new Getter<>() {
            @Override
            public Timespan get(EntityAirChangeEvent event) {
                return new Timespan(Timespan.TimePeriod.TICK, event.getAmount());
            }
        }, EventValues.TIME_NOW);
