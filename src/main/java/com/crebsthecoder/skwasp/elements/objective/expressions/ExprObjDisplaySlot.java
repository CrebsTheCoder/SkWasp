package com.crebsthecoder.skwasp.elements.objective.expressions;
...
public class ExprObjDisplaySlot extends SimpleExpression<DisplaySlot> {
    ...
    static {
        Skript.registerExpression(ExprObjDisplaySlot.class, DisplaySlot.class, ExpressionType.COMBINED, "display[ ]slot of %objective%");
    }
